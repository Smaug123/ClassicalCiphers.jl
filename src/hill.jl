...
"""
function encrypt_hill(plaintext, key::Array{Integer, 2})
...
function minor(mat::Array{Integer, 2}, i, j)
...
"""
function adjugate(mat::Array{Integer, 2})
...
function decrypt_hill(ciphertext, key::Array{Integer, 2})
	if ndims(key) != 2
